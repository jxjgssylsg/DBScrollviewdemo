...
- (void)reloadImage
{
    ...
    _centerImageView.backgroundColor = [UIColor colorWithRed:_currentImageIndex/10.0f green:_currentImageIndex/10.0f blue:_currentImageIndex/10.0f alpha:1]; // 没图片所以写个颜色值意思一下
    //
